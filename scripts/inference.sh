...
python /usr/people/tt1131/projects/MMMmB/qmc_deep_gen/analyze_mouse_latents.py \
    --model_path /usr/people/tt1131/projects/MMMmB/qmc_deep_gen/results/mouse_test_small_100k_binary/qmc_train_mouse_experiment.tar \
    --dataloc /jukebox/falkner/Dexter/vocal_beh/data/full_dataset/preprocessed_500k_110_centered_512/ \
    --save_dir /usr/people/tt1131/projects/MMMmB/qmc_deep_gen/results/mouse_test_small_100k_binary/latents \
    --lattice_m 25 \
    --bandwidth 0.1 \
    --batch_size 1 \